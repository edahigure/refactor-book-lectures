...
class InscriptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create inscription" do
    assert_difference("Inscription.count") do
      post inscriptions_url, params: { inscription: { course_id: @inscription.course_id, paid: @inscription.paid, payment: @inscription.payment, removed: @inscription.removed, user_id: @inscription.user_id } }
    end
  ...
  test "should update inscription" do
    patch inscription_url(@inscription), params: { inscription: { course_id: @inscription.course_id, paid: @inscription.paid, payment: @inscription.payment, removed: @inscription.removed, user_id: @inscription.user_id } }
